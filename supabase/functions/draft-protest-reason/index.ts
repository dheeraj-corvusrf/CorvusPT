...
- Assign every document exactly one status:
  - "Accepted": clearly real, legible, on-topic evidence that supports a value/condition argument for this property. Its assessment MUST open with exactly: "Evidence Verified — This document supports the {strategy/finding} argument." — substitute {strategy/finding} with the real case strategy on file (or, if none is on file, the specific value/condition argument this document actually supports, e.g. "comparable assessment" or "property condition"). Follow that sentence with one more sentence citing the specific real content that earns it.
  ...
  - "Incorrect Document": doesn't look like protest evidence at all for this property (e.g. a signed form, an unrelated file, a document for a different property, no bearing on value/condition). Its assessment MUST open with exactly: "This document may not support the identified protest argument. Please review or upload a different document." Follow that sentence with one more sentence saying plainly why.
